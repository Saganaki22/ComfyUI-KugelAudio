"""SageAttention patch implementation for KugelAudio.

Adapted from ComfyUI-VibeVoice implementation.
Author: Wildminder (original), Adapted for KugelAudio
License: Apache 2.0
"""
...
def sage_attention_forward(
    ...
    **kwargs,
    ...
    """Custom forward method for Qwen2Attention using SageAttention."""
...
def set_sage_attention(model):
    ...
    if SAGE_ATTENTION_FUNCTION is None:
        logger.warning("SageAttention kernel not available for this GPU, skipping patch")
        return
